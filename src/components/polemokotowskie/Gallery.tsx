...
const photos = [
  { src: '/gallery/images (1).jpg', alt: 'Pole Mokotowskie 全景' },
  { src: '/gallery/images (2).jpg', alt: '中央开阔草坪' },
  { src: '/gallery/images (3).jpg', alt: '环湖景观步道' },
  { src: '/gallery/images (5).jpg', alt: '林荫大道' },
  { src: '/gallery/images (6).jpg', alt: '湖面倒影' },
  { src: '/gallery/images (7).jpg', alt: '草坪日落' },
  { src: '/gallery/images (8).jpg', alt: '纪念艺术装置' },
  { src: '/gallery/images (9).jpg', alt: '本地休闲氛围' },
];
