...
const photos = [
  ...
  { src: '/gallery/images (2).jpg', alt: '圣米迦勒教堂' },
  { src: '/gallery/images (3).jpg', alt: '马加什·科温骑马雕像' },
  { src: '/gallery/images (5).jpg', alt: '广场夜景' },
  { src: '/gallery/images (6).jpg', alt: '中世纪建筑群落' },
  { src: '/gallery/images (7).jpg', alt: '巴洛克建筑立面' },
  { src: '/gallery/images (8).jpg', alt: '哥特式尖塔' },
  { src: '/gallery/images (9).jpg', alt: '东欧风情' },
];
